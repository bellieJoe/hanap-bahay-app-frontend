...
export class SubscribePage implements OnInit {
    ...
    async validate(a:number){
      let validationResult : any;
      this.errors = {}
      if(a === 1){
        validationResult = await this.validator.validateOnly(
          {
            RRP_Name: this.rh_user_inputs.RRP_Name,
            RRP_Address: this.rh_user_inputs.RRP_Address,
            Contact_Number: this.rh_user_inputs.Contact_Number
          }, 
          ['RRP_Name', 'RRP_Address', 'Contact_Number'])
